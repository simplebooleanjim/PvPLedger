...
echo Fetching US Solo Shuffle ladder snapshot from Battle.net...
%PYTHON% export_ladder.py --fetch-blizzard --bracket shuffle --region US --output "..\Data\LadderData_US_Shuffle.lua"
